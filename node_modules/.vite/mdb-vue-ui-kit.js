...
var _sfc_main$Y = defineComponent(__spreadProps(__spreadValues({}, __default__$Y), {
  props: {
    badge: String,
    color: String,
    pill: Boolean,
...
var runRipple = (el, waveConfig, options) => {
  ...
  const styles = {
    ...
    height: `${Math.round(options.radius && options.radius * 2 || diameter)}px`,
    width: `${Math.round(options.radius && options.radius * 2 || diameter)}px`,
...
var _sfc_main$X = defineComponent(__spreadProps(__spreadValues({}, __default__$X), {
  props: {
    color: String,
    size: String,
    outline: String,
...
var _sfc_main$W = defineComponent(__spreadProps(__spreadValues({}, __default__$W), {
  props: {
    size: String,
    vertical: Boolean,
    role: {
...
var _sfc_main$V = defineComponent(__spreadProps(__spreadValues({}, __default__$V), {
  props: {
    white: {
      type: Boolean,
      default: false
...
var _sfc_main$U = defineComponent(__spreadProps(__spreadValues({}, __default__$U), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$T = defineComponent(__spreadProps(__spreadValues({}, __default__$T), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$S = defineComponent(__spreadProps(__spreadValues({}, __default__$S), {
  props: {
    tag: {
      type: String,
      default: "h5"
...
var _sfc_main$R = defineComponent(__spreadProps(__spreadValues({}, __default__$R), {
  props: {
    tag: {
      type: String,
      default: "p"
...
var _sfc_main$Q = defineComponent(__spreadProps(__spreadValues({}, __default__$Q), {
  props: {
    tag: {
      type: String,
      default: "img"
...
var _sfc_main$P = defineComponent(__spreadProps(__spreadValues({}, __default__$P), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$O = defineComponent(__spreadProps(__spreadValues({}, __default__$O), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$N = defineComponent(__spreadProps(__spreadValues({}, __default__$N), {
  props: {
    tag: {
      type: String,
      default: "a"
...
var _sfc_main$M = defineComponent(__spreadProps(__spreadValues({}, __default__$M), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$L = defineComponent(__spreadProps(__spreadValues({}, __default__$L), {
  props: {
    captionsClass: {
      type: String,
  ...
  setup(__props, { expose, emit }) {
    ...
    watch(() => props.modelValue, (targetItemKey) => slideTo(targetItemKey));
    expose({ next, prev });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(resolveDynamicComponent(__props.tag), {
        class: normalizeClass(unref(className)),
...
var _sfc_main$K = defineComponent(__spreadProps(__spreadValues({}, __default__$K), {
  props: {
    flush: {
      type: Boolean,
      default: false
...
var _sfc_main$J = defineComponent(__spreadProps(__spreadValues({}, __default__$J), {
  props: {
    tag: {
      type: String,
      default: "li"
...
var _sfc_main$I = defineComponent(__spreadProps(__spreadValues({}, __default__$I), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$H = defineComponent(__spreadProps(__spreadValues({}, __default__$H), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$G = defineComponent(__spreadProps(__spreadValues({}, __default__$G), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var off = function(element, event, handler, delegationFn = void 0) {
  ...
  const [delegation, originalHandler, typeEvent] = normalizeParams(event, handler, delegationFn);
  removeHandler(element, typeEvent, originalHandler, delegation ? handler : null);
};
var __default__$F = {
  name: "MDBCollapse"
};
var _sfc_main$F = defineComponent(__spreadProps(__spreadValues({}, __default__$F), {
  props: {
    tag: {
      type: String,
      default: "div"
  ...
  setup(__props, { expose, emit }) {
    ...
    const incrementAccordionItemsCount = inject("incrementAccordionItemsCount", false);
    ...
    watch(() => navbarFlexWrapValue && navbarFlexWrapValue.value, (cur, prev) => {
      if (cur === "nowrap") {
        isActive.value = true;
      } else if (cur === "wrap") {
...
function MDBPopper() {
  ...
  function setPopper(trigger, popper22, config) {
    ...
    popperOptions.value = __spreadValues({
      placement: "bottom",
      modifiers: [
        {
          name: "offset",
  ...
  function setupPopper() {
    ...
    if (popper2.value === void 0 || !popper2.value) {
      popper2.value = createPopper(triggerEl.value, popperEl.value, popperOptions.value);
    } else {
...
var handleBreakpoints = (windowWidth, breakpointValues) => {
  ...
  breakpointValues.forEach((value2) => {
    const match = Object.keys(breakpoints).filter((breakpoint) => value2.includes(breakpoint) ? breakpoint : false)[0];
    if (match) {
...
var _sfc_main$E = defineComponent(__spreadProps(__spreadValues({}, __default__$E), {
  props: {
    tag: {
      type: String,
      default: "div"
  ...
  setup(__props, { emit }) {
    ...
    watch(() => isMenuMounted.value, (cur) => handleMenuMountedState(cur), { immediate: true });
    ...
    const getConfig = () => {
      if (typeof props.align === "string") {
        ...
        menuAlignClasses.value = props.align.map((prop) => `dropdown-menu-${prop}`.trim());
      }
      ...
      return __spreadValues(__spreadValues({}, defaultBsPopperConfig), typeof props.popperConfig === "function" ? props.popperConfig(defaultBsPopperConfig) : props.popperConfig);
    };
    const popperSetup = () => {
    ...
    const getBreakpointValue = () => {
      ...
      const activeBrakpointValue = handleBreakpoints(windowWidth.value, propsValues);
...
var _sfc_main$D = defineComponent(__spreadProps(__spreadValues({}, __default__$D), {
...
var _sfc_main$C = defineComponent(__spreadProps(__spreadValues({}, __default__$C), {
  props: {
    tag: {
      type: String,
      default: "ul"
  ...
  setup(__props) {
    ...
    if (isPopperActive) {
      watch(() => isPopperActive.value, (cur, prev) => {
        if (!root.value) {
          return;
        }
...
var _sfc_main$B = defineComponent(__spreadProps(__spreadValues({}, __default__$B), {
  props: {
    tag: {
      type: String,
      default: "a"
...
var _sfc_main$A = defineComponent(__spreadProps(__spreadValues({}, __default__$A), {
  props: {
    tag: {
      type: String,
      default: "span"
  ...
  setup(__props, { emit }) {
    ...
    const getConfig = () => {
      ...
      return __spreadValues(__spreadValues({}, defaultBsPopperConfig), typeof props.options === "function" ? props.options(defaultBsPopperConfig) : props.options);
    };
    const popperSetup = () => {
...
var _sfc_main$z = defineComponent(__spreadProps(__spreadValues({}, __default__$z), {
  props: {
    tag: {
      type: String,
      default: "span"
...
function MDBFocusTrap() {
  ...
  function calculateFocusTrap() {
    const focusable = Array.from(trapElement.value.querySelectorAll('button, a, input, select, textarea, [tabindex]:not([tabindex="-1"])')).filter((el) => {
    ...
    on(lastFocusableElement.value, "keydown", (e) => handleLastElementKeydown(e));
  }
...
var _sfc_main$d = defineComponent(__spreadProps(__spreadValues({}, __default__$d), {
  ...
  setup(__props) {
    ...
    watchEffect(() => isActive.value = activeTabId && activeTabId.value === props.tabId);
    const handleClick = () => {
...
var _sfc_main$9 = defineComponent(__spreadProps(__spreadValues({}, __default__$9), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$8 = defineComponent(__spreadProps(__spreadValues({}, __default__$8), {
  props: {
    tag: {
      type: String,
      default: "div"
...
var _sfc_main$7 = defineComponent(__spreadProps(__spreadValues({}, __default__$7), {
  props: {
    tag: {
      type: String,
      default: "table"
...
var _sfc_main$6 = defineComponent(__spreadProps(__spreadValues({}, __default__$6), {
  props: {
    id: String,
    label: String,
    labelClass: String,
  ...
  setup(__props, { expose, emit }) {
    ...
    const handleMultipleNotchesVisibility = (isFocused) => {
      inputNotchElements.value.forEach((notch) => notch.style.opacity = isFocused ? "0" : "1");
      if (isFocused) {
    ...
    const isFirstChild = (element) => {
      return !Boolean([...element.parentNode.children].findIndex((item) => item === element));
    };
    onMounted(() => {
      calcNotch();
      setPlaceholder();
    ...
    watch(() => props.isValidated, (value) => isInputValidated.value = value);
    watch(() => props.isValid, (value) => isInputValid.value = value);
    expose({
      inputRef
    });
    return (_ctx, _cache) => {
...
var _sfc_main$5 = defineComponent(__spreadProps(__spreadValues({}, __default__$5), {
  props: {
    id: String,
    rows: {
      type: [String, Number],
...
var _sfc_main$4 = defineComponent(__spreadProps(__spreadValues({}, __default__$4), {
  props: {
    id: String,
    label: String,
    modelValue: Boolean,
...
var _sfc_main$3 = defineComponent(__spreadProps(__spreadValues({}, __default__$3), {
  props: {
    id: String,
    label: String,
    inline: Boolean,
...
var _sfc_main$2 = defineComponent(__spreadProps(__spreadValues({}, __default__$2), {
  props: {
    id: String,
    inputClass: String,
    invalidFeedback: String,
...
var setNestedActive = (links, index, container) => {
  ...
  const allNestedLinks = Array.from(allLinks.parentNode.querySelectorAll("a"));
